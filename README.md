[![Run App NathanRoberts](https://github.com/nroberts6/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/nroberts6/GithubActions/actions/workflows/run-app.yaml)
